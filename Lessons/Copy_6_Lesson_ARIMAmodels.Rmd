...
electricity_price_processed <-
  ...
  arrange( Month ) #arrange data frame by month
...
df_residential <- data.frame( Month = electricity_price_processed$Month,
                             ...
                             NonSeasonalResidential = as.numeric(deseasonal_residential_price))#as numeric because previously it is ts but ggplot can only plot data frame
...
#deseason still have the decay because there is still trend
