...
#H0: stationary
#small p value, reject null, not stationary
#positive S, increasing trend
#tau is pointing stronger trend working at the 
#p telling if the tau is significant, have more confidence to say 
#tau is 2S/N(N-1)
#tau also gives correlation
```
...
print(sp_rho)
# if close to one, there is no trend
#reject the null, true rho is not equal to 0 so there is a trend
#cannot handle seasonal data
#rho greater than 1, positive trend
```
