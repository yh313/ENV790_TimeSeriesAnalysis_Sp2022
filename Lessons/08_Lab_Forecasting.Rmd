...
```{r}
BR_MEAN_deseas <- meanf(BR_Temp_ts_deseas, h=36)
plot(BR_MEAN_deseas)

BR_NAIVE_deseas <- naive(BR_Temp_ts_deseas, h=36)
plot(BR_NAIVE_deseas)

BR_SMA_deseas_fit <- sma(y = BR_Temp_ts_deseas, h = 36, holdout = FALSE, silent = FALSE) #order=2
summary(BR_SMA_deseas_fit)

BR_deseas_fit=ses( y = BR_Temp_ts_deseas, h = 36, holdout = FALSE, silent = FALSE)
