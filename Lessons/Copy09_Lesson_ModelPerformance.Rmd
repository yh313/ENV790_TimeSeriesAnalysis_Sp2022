...
#residual=observed-mean of the series
```
...
#ACF shows residual is autogression (but we don't want relationship between residuals)
```
...
#if specifies h when fitting, then it is already forecast format. 
#main also provide ACF value: don't want autoregression
```
